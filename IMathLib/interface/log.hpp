...
namespace iml {
	namespace i_f {
		...
		public:
			...
			static const size_t error = 2;
			static const size_t fatal = 3;
			//エラーコードの識別定数
			static const size_t	none = 0;						//なし
			static const size_t	variable_error = 1;				//変数
			static const size_t	function_error = 2;				//関数
			static const size_t	file_read_error = 3;			//ファイル読み込み
			static const size_t	file_format_error = 4;			//ファイル形式
			static const size_t data_error = 5;					//一般的なデータ
