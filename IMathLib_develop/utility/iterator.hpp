...
namespace iml {
	...
	struct _Get_element_type {
		template <class S>
		static auto tester(int)->identity<typename S::element_type> {}
		template <class S>
		static auto tester(_Wrap_int)->identity<typename _Get_first_parameter<S>::type> {}
	...
	struct _Get_ptr_difference_type {
		template <class S>
		static auto tester(int)->identity<typename S::difference_type> {}
		template <class S>
		static auto tester(_Wrap_int)->identity<ptrdiff_t> {}
	...
	struct _Get_rebind_type {
		template <class S>
		static auto tester(int)->identity<typename S::template rebind<_Other>::other> {}
		template <class S>
		static auto tester(_Wrap_int)->identity<typename _Replace_first_parameter<_Other, S>::type> {}
